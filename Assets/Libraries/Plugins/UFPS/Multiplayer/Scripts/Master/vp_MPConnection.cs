...
public class vp_MPConnection : Photon.MonoBehaviour
{
    ...
    void OnJoinedLobby()
    {
        ...
        PhotonNetwork.player.name = vp_Gameplay.PlayerName;
    ...
    void OnPhotonPlayerDisconnected(PhotonPlayer player)
    {
        ...
        vp_MPDebug.Log(player.name + " left the game"); // NOTE: the 'joined' message is posted by vp_MPPlayerSpawner which has extended team info
